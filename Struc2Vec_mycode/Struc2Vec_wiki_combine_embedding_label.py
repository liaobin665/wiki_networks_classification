...
embedding_pd = pd.read_csv("../data/embedding_file/Stuc2Vec_wiki_embeding.csv",index_col='node_id')
# 对node_id进行排序
...
full_pd.to_csv('../data/embedding_file/Stuc2Vec_wiki_embeding_label.csv',index=0)
