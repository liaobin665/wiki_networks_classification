...
embeding_label_pd=pd.read_csv("../data/embedding_file/Stuc2Vec_wiki_embeding_label.csv")
...
full_pd.to_csv('../data/embedding_file/Struc2Vec_wiki_embeding_label_extinfo.csv', index=0)
