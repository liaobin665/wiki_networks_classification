...
embeding_label_pd=pd.read_csv("../data/embedding_file/LINE_wiki_embeding_label.csv")
...
full_pd.to_csv('../data/embedding_file/LINE_wiki_embeding_label_extinfo.csv', index=0)
