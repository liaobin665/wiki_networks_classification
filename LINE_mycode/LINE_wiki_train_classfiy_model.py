...
total_pd = pd.read_csv("../data/embedding_file/LINE_wiki_embeding_label_extinfo.csv")
...
cvResDf.to_csv("../data/result/line_wiki_embedding_ext_accuracy_result.csv")
# cvResDf.to_csv("../data/result/line_wiki_embedding_accuracy_result.csv")
# 可视化查看不同算法的表现情况
