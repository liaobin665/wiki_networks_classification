...
# total_pd = pd.read_csv("../data/embedding_file/node2vec_wiki_embeding_label.csv")
...
# cvResDf.to_csv("../data/result/node2vec_wiki_embedding_accuracy_result.csv")
cvResDf.to_csv("../data/result/node2vec_wiki_embedding_ext_accuracy_result_withXGB.csv")
# 可视化查看不同算法的表现情况
