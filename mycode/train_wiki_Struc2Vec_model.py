...
total_pd = pd.read_csv("../data/embedding_file/wiki_embeding_with_lable_extinfo_Struc2Vec.csv")
# total_pd = pd.read_csv("../data/embedding_file/wiki_embeding_with_label_extinfo_Struc2Vec.csv")
# 这是加了节点额外结构信息的数据来源
